package com.bear.bearspring.common.exception;
...
public class CustomiseException extends Exception {
  ...
  /**
   * @param statusCode       the http status code
   * @param localizationCode the {@code localizationCode} is to map or localize
   * @param message          the error message
   */
   ...
   * @param localizationCode the {@code localizationCode} is to map or localize
   * @param message          the error message
   * @param internalMessage  the system error message is to trace error
   */
